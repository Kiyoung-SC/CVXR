...
def match_and_pose_estimation(img_ref, kp_ref, des_ref, frame, detector, descriptor, norm_type, 
                               ...
                               camera_matrix, target_corners_3d, show_matches):
    """
    Match features and estimate camera pose from homography
    Returns: result_image, kp_count, good_count, inlier_count, has_pose, rvec, tvec
    """
    ...
    if des_ref is None or des_frame is None or len(kp_frame) == 0:
        ...
        return result, 0, 0, 0, has_pose, rvec, tvec
    ...
    return result, len(kp_frame), len(good_matches), inlier_count, has_pose, rvec, tvec
...
def main():
    ...
    while True:
        ...
        result, kp_count, good_count, inlier_count, has_pose, rvec, tvec = match_and_pose_estimation(
        ...
        # Display the result
        cv2.imshow('Camera Pose Estimation', result)
        ...
        if key == ord('q'):
            ...
            output_path = f'output/pose_{method_name.lower()}_{frame_count}.jpg'
